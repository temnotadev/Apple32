...
// RFXCORE // ОРИГИНАЛЬНАЯ ЛОГИКА КНОПКИ
...
void initDisplay() {
  ...
  tft.setTextSize(2);
  tft.drawCentreString("BLE32 v4.3", 160, 12, 1);
  ...
  tft.drawString("RFXCORE", 20, 12, 1);
}
...
void showMainMenu() {
  ...
  tft.setTextSize(2);
  tft.drawCentreString("BLE Attack", 160, yPosAttack, 1);
...
void showAboutScreen() {
  ...
  tft.drawCentreString("TFT 240x320 Landscape", 160, 140, 2);
  ...
  tft.drawCentreString("Protocols: 4 Supported", 160, 245, 1);
...
void updateDeviceInfo() {
  ...
  tft.drawCentreString("Press: Start/Stop", 160, 210, 2);
}
...
void setup() {
  ...
  Serial.println("[+] Multi-Protocol BLE Firmware v4.3");
  ...
  Serial.println("[+] Hold 3s: Main menu");
}
